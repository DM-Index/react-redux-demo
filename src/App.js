    ...
    return (
      <div className="App">
        <p>
          ...
          <button onClick={() => this.props.updateName(this.refs.name.value)}>
            Update
          </button>
        </p>
        <p>
...
function moveFromStoreToProps(state) {
  ...
  // }
  return {
    //This object gets mashed/merged into this.props
    people: people,
    name: name
  };
}
...
connect(mapStateToProps, { updateName, addPerson })(App);
